...
const u8 gText_SaveFileUpdated[] = _("Il salvataggio è aggiornato."); // Unused
const u8 gText_SaveFileCorrupted[] = _("Il salvataggio è corrotto. Il\nsalvataggio precedente sarà caricato.");
const u8 gText_SaveFileErased[] = _("Il salvataggio è stato cancellato\nperché danneggiato.");
const u8 gJPText_No1MSubCircuit[] = _("1Mサブきばんが ささっていません！");
const u8 gText_BatteryRunDry[] = _("Problema di batteria interna.\nIl gioco può essere giocato.\pTuttavia, gli eventi relativi all'orario\nnon funzioneranno.");
...
const u8 gText_RButton[] = _("Pulsante R"); // Unused
const u8 gText_LButton[] = _("Pulsante L"); // Unused
...
const u8 gText_Controls[] = _("CONTROLLI"); // Unused
...
const u8 gText_WhatWouldYouLike[] = _("Cosa vorresti fare?");
...
const u8 gText_CloseBag[] = _("CHIUDI LA BORSA");
...
const u8 gText_ReturnToVar1[] = _("Ritorna al\n{STR_VAR_1}.");
const u8 gText_ItemsPocket[] = _("OGGETTI");
const u8 gText_PokeBallsPocket[] = _("POKé BALLS");
const u8 gText_TMHMPocket[] = _("MT e MN");
const u8 gText_BerriesPocket[] = _("BACCHE");
const u8 gText_KeyItemsPocket[] = _("OGGETTI SP.");
...
const u8 gText_SpaceForVar1Full[] = _("Lo spazio per {STR_VAR_1} è finito.{PAUSE_UNTIL_PRESS}");
const u8 gText_AnythingElseICanHelp[] = _("C'è qualcos'altro che posso\nfare per te?");
...
const u8 gText_Switch2[] = _("SCAMBIA");
const u8 gText_Summary5[] = _("RIEPILOGO");
...
const u8 gText_TeachWhichPokemon2[] = _("Insegnare a quale POKéMON?"); // Unused
const u8 gText_ChoosePokemon[] = _("Scegliere un POKéMON.");
const u8 gText_MoveToWhere[] = _("Muoverlo dove?");
const u8 gText_TeachWhichPokemon[] = _("Insegnare a quale POKéMON?");
...
const u8 gText_RestoreWhichMove[] = _("Recuperare quale mossa?");
const u8 gText_BoostPp[] = _("Potenziare PP di quale mossa?");
const u8 gText_DoWhatWithItem[] = _("Cosa fare con un oggetto?");
const u8 gText_NoPokemonForBattle[] = _("No POKéMON for battle!");
const u8 gText_ChoosePokemon2[] = _("Scegli un POKéMON.");
const u8 gText_NotEnoughHp[] = _("Non abbastanza HP…");
...
const u8 gText_ChoosePokemonCancel[] = _("Scegli un POKéMON o CANCELLA.");
...
ALIGNED(4) const u8 gText_ThatIsntAnEgg[] = _("Non è un uovo.");
const u8 gText_Register[] = _("REGISTRA");
const u8 gText_Attack3[] = _("ATTACCO");
const u8 gText_Defense3[] = _("DIFESA");
const u8 gText_SpAtk4[] = _("ATTACCO SP.");
const u8 gText_SpDef4[] = _("DIFESA SP.");
const u8 gText_Speed2[] = _("VELOCITA'");
...
const u8 gText_EggWillTakeALongTime[] = _("Sembra che l'UOVO ci\nmetterà tanto a schiudersi.");
const u8 gText_EggWillTakeSomeTime[] = _("Che cosa uscirà da quest'uovo?\nCi vorrà un pò di tempo.");
const u8 gText_EggWillHatchSoon[] = _("Si muove a volte.\nDovrebbe schiudersi presto.");
const u8 gText_EggAboutToHatch[] = _("Sta facendo rumori.\nSta per schiudersi!");
const u8 gText_HMMovesCantBeForgotten2[] = _("HM moves non può essere\ndimenticata adesso.");
...
const u8 gText_Items[] = _("OGGETTI");
const u8 gText_Key_Items[] = _("OGGETTI CHIAVE");
const u8 gText_Poke_Balls[] = _("POKé BALLS");
const u8 gText_TMs_Hms[] = _("MT & MN");
...
const u8 gText_HeldItem[] = _("OGGETTI TENUTI");
...
const u8 gText_HoldItems[] = _("OGGETTI TENUTI");
const u8 gText_Symbols2[] = _("SIMBOL");
...
const u8 gText_HeldItems[] = _("OGGETTI TENUTI");
...
const u8 gText_Rest[] = _("RIPOSA");
const u8 gText_Retire[] = _("RITIRA");
...
const u8 gPCText_Cancel[] = _("CANCELLA");
const u8 gPCText_Store[] = _("CONSERVA");
const u8 gPCText_Withdraw[] = _("RITIRA");
const u8 gPCText_Shift[] = _("SHIFT");
const u8 gPCText_Move[] = _("MUOVI");
const u8 gPCText_Place[] = _("POSIZIONA");
const u8 gPCText_Summary[] = _("RIEPILOGO");
const u8 gPCText_Release[] = _("RILASCIO");
const u8 gPCText_Mark[] = _("SEGNO");
const u8 gPCText_Name[] = _("NOME");
const u8 gPCText_Jump[] = _("SALTO");
const u8 gPCText_Wallpaper[] = _("WALLPAPER");
const u8 gPCText_Take[] = _("PRENDERE");
const u8 gPCText_Give[] = _("DARE");
const u8 gPCText_Switch[] = _("SCAMBIA");
const u8 gPCText_Bag[] = _("BORSA");
...
const u8 gPCText_Cave[] = _("CAVA");
const u8 gPCText_Beach[] = _("SPIAGGIA");
const u8 gPCText_Seafloor[] = _("MARE");
...
const u8 gPCText_Simple[] = _("SEMPLICE");
const u8 gText_WhatWouldYouLikeToDo[] = _("Cosa vorresti fare?"); // Unused
const u8 gText_WithdrawPokemon[] = _("RITIRA POKéMON");
const u8 gText_DepositPokemon[] = _("DEPOSITA POKéMON");
const u8 gText_MovePokemon[] = _("MUOVI POKéMON");
const u8 gText_MoveItems[] = _("MUOVI OGGETTI");
const u8 gText_SeeYa[] = _("CI VEDIAMO!");
const u8 gText_WithdrawMonDescription[] = _("Muovi i POKéMON in BOXES\nnella tua squadra.");
const u8 gText_DepositMonDescription[] = _("Conserva i POKéMON della tua squadra\n nei BOX.");
const u8 gText_MoveMonDescription[] = _("Organizza i POKéMON nei BOX e\nnella tua squadra.");
const u8 gText_MoveItemsDescription[] = _("Muovi oggetti tenuti da un POKéMON\nin un BOX o nella squadra.");
const u8 gText_SeeYaDescription[] = _("Ritorna al MENU precedente.");
const u8 gText_JustOnePkmn[] = _("Solo un POKéMON è con te.");
const u8 gText_PartyFull[] = _("La tua squadra è piena!");
const u8 gText_Box[] = _("BOX");
const u8 gText_CheckMapOfHoenn[] = _("Controlla la mappa di ANCAR.");
...
const u8 gText_PutAwayPokenav[] = _("Metti via il POKéNAV.");
...
const u8 gText_ReturnToPokenavMenu[] = _("Ritorna al menu POKéNAV.");
...
const u8 gText_NumberRegistered[] = _("No. REGISTRATO");
const u8 gText_NumberOfBattles[] = _("No. DI BATTAGLIA");
const u8 gText_Detail[] = _("DETTAGLIO"); // Unused
const u8 gText_Call2[] = _("CHIAMA"); // Unused
const u8 gText_UnusedExit[] = _("ESCI"); // Unused
...
const u8 gText_PokenavMatchCall_TrainerPokemon[] = _("POKéMON DELL'ALLENATORE");
...
const u8 gText_TrainerCardMoney[] = _("DENARO");
...
const u8 gText_Upper[] = _("PIU' ALTO");
const u8 gText_Lower[] = _("PIU' BASSO");
...
const u8 gText_Battle[] = _("BATTAGLIA");
const u8 gText_Lets[] = _("LET'S");
const u8 gText_Ok[] = _("OK!");
const u8 gText_Sorry[] = _("SCUSAY");
...
const u8 gText_ContinueMenuPlayer[] = _("GIOCATORE");
...
const u8 gText_TextSpeed[] = _("TESTO");
const u8 gText_BattleScene[] = _("SCENE LOTTA");
const u8 gText_BattleStyle[] = _("STILE LOTTA");
const u8 gText_Sound[] = _("SUONO");
const u8 gText_Frame[] = _("FRAME");
const u8 gText_OptionMenuCancel[] = _("CANCELLA");
const u8 gText_ButtonMode[] = _("BUTTON MODE");
const u8 gText_TextSpeedSlow[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}LEN.");
const u8 gText_TextSpeedMid[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}MED.");
const u8 gText_TextSpeedFast[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}VEL.");
const u8 gText_BattleSceneOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ACCESO");
const u8 gText_BattleSceneOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}SPENTO");
...
const u8 gText_UpdatedTime[] = _("Tempo aggiornato"); // Unused
...
const u8 gText_MenuRetire[] = _("RITIRA");
...
const u8 gText_YourName[] = _("Il tuo nome?");
...
const u8 gText_SelectFirstPkmn[] = _("Seleziona il primo POKéMON.");
const u8 gText_SelectSecondPkmn[] = _("Seleziona il secondo POKéMON.");
const u8 gText_SelectThirdPkmn[] = _("Seleziona il terzo POKéMON.");
const u8 gText_Rent[] = _("NOLEGGIO");
const u8 gText_Summary[] = _("RIEPILOGO");
const u8 gText_Others2[] = _("ALTRI");
const u8 gText_Deselect[] = _("DESELEZIONA");
...
const u8 gText_Cancel3[] = _("CANCELLA");
...
ALIGNED(4) const u8 gText_ReturnToTitle[] = _("Ritorna alla schermata del titolo.");
...
const u8 gText_IsThisTheCorrectTime[] = _("E' l'orario giusto?");
const u8 gText_Confirm3[] = _("CONFERMA");
const u8 gText_Cancel4[] = _("CANCELLA");
