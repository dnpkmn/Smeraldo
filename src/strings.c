...
const u8 gText_TMHMPocket[] = _("TMs e HMs");
const u8 gText_BerriesPocket[] = _("BACCHE");
const u8 gText_KeyItemsPocket[] = _("OGGETTI CHIAVE");
...
const u8 gText_DepositMonDescription[] = _("Conserva i POKéMON nella tua squadra in BOXES.");
const u8 gText_MoveMonDescription[] = _("Organizza i POKéMON in BOXES e\nnella tua squadra.");
